---
name: showcase
description: Visual polish for videos via Remotion-powered window chrome, animations, and branded backgrounds.
---
# Showcase Polish
...
```bash
cd ${PI_AGENT_CONTROL_ROOT}/remotion && npm install
```
