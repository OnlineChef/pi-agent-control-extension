---
name: true-input
description: True-input driver mechanics for real terminal emulator automation via headless Wayland compositor.
---
# True-Input Driver
...
- Validating that Pi handles a keystroke correctly end-to-end in a specific terminal
